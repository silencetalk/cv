...
<body>
    <div class="container">
        ...
        <form action="user_save.php" method="post" id="form_reg" onsubmit="send_form('form_reg');return false;">
            ...
            <p><input type="text" name="username" placeholder="用户名" class="middle" /></p>
            <p><input type="text" name="userid" placeholder="工号" class="middle" /></p>
            <p><input type="text" name="email" placeholder="Email" class="middle" /></p>
            <p><input type="text" name="phonenum" placeholder="手机号" class="middle" /></p>
